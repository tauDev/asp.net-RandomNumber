...
<link href="Content/bootstrap.css" rel="stylesheet" />
 ...
 <style>
  ...
  margin: 0;
  padding: 0;
  background-image:url(images/yeen.jpg);
...
<body translate="no">
    ...
    <div class="RunndomText">
        ...
        <div class="row">
            ...
            <div class="col">
                <h1>Happy ID : </h1><br />
                <h1><asp:Label runat="server" ID="lb1"></asp:Label></h1><br />
                <h1>Name :</h1><br />
                <h1><asp:Label runat="server" ID="lblname"></asp:Label></h1><br/>
                <h1>Department : </h1>
                <h1><asp:Label runat="server" ID="lblDep"></asp:Label></h1>
            </div>
        </div>     
